...
@Composable
fun BeefVeal(navController: NavController) {
    OuiChefComposeTheme {
        Column(
            modifier = Modifier
                .fillMaxSize()
            ...
            Box() {
                ...
                val titleBeef = "Beef & veal"
                val infoBeef = stringResource(R.string.beef_veal_cut)
                ExpandableCard(
                    title = titleBeef,
                    description = infoBeef,
            ...
            Box(
                ...
                Image(
                    ...
                    painter = painterResource(R.drawable.beef_cut4),
                    contentDescription = "beefCut"
                )
            }
