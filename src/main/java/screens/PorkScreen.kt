...
@Composable
fun Pork(navController: NavController) {
    OuiChefComposeTheme {
        Column(
            modifier = Modifier
                .fillMaxSize()
            ...
            Row(
                ...
                val titlePork = "Pork"
                val infoPork = stringResource(R.string.pork_cut)
                ExpandableCard(
                    title = titlePork,
                    description = infoPork,
            ...
            Box(
                ...
                Image(
                    ...
                    painter = painterResource(R.drawable.pork_cut1),
                    contentDescription = "porkCut"
                )
            }
